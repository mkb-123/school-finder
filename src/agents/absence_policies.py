...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """Parse command-line arguments for the absence policies agent.
    ...
    parser = argparse.ArgumentParser(
        description="Collect absence/attendance policy information for schools in a council.",
    )
    parser.add_argument(
        "--council",
        required=True,
...
def main(argv: list[str] | None = None) -> None:
    """CLI entry point for the absence policies agent.
