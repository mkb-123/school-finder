  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 sm:py-16" role="main">
      ...
      <form
        ...
        className="mt-8 rounded-xl border border-gray-200 bg-white p-5 shadow-sm sm:mt-10 sm:p-8"
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1.5 block w-full rounded-lg border border-gray-300 px-3 py-3 text-base shadow-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
            />
            <p id="postcode-hint" className="mt-1.5 text-xs text-gray-500">
      ...
      <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="group flex items-start gap-3 rounded-xl border border-gray-200 bg-white p-4 transition-shadow hover:shadow-sm">
          <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-blue-50 text-blue-600">
            <MapPin className="h-5 w-5" aria-hidden="true" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-gray-900">Catchment maps</h3>
        ...
        <div className="group flex items-start gap-3 rounded-xl border border-gray-200 bg-white p-4 transition-shadow hover:shadow-sm">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900">Compare schools</h3>
            <p className="mt-0.5 text-xs leading-relaxed text-gray-500">
        ...
        <div className="group flex items-start gap-3 rounded-xl border border-gray-200 bg-white p-4 transition-shadow hover:shadow-sm">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900">Journey planner</h3>
            <p className="mt-0.5 text-xs leading-relaxed text-gray-500">
