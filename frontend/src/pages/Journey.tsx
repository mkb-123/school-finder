        ...
        <aside className="space-y-4 lg:col-span-4" aria-label="Journey settings">
              ...
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <input
                    ...
                    className="block w-full rounded-lg border border-gray-300 py-3 pl-9 pr-3 text-sm shadow-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
                  />
                </div>
              </div>
                  ...
                  {TRANSPORT_MODES.map((m) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex min-h-[44px] items-center justify-center gap-1.5 rounded-lg px-3 py-2.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 ${
                          isActive
              ...
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <input
                    ...
                    className="block w-full rounded-lg border border-gray-300 py-2.5 pl-9 pr-3 text-sm shadow-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                  />
                </div>
          ...
          {journeys.length === 0 && !loading && !error && (
            <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-3 rounded-lg border-2 border-dashed border-gray-200 px-4 py-8 text-center">
                <RouteIcon className="mx-auto h-8 w-8 text-gray-300" aria-hidden="true" />
