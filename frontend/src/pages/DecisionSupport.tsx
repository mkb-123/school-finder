...
export default function DecisionSupport() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6 sm:py-8 print:px-0" role="main">
      <h1 className="text-2xl font-bold text-stone-900 sm:text-3xl">Decision Support</h1>
          ...
          <section className="rounded-lg border border-stone-200 bg-white p-5">
            ...
            <div className="mt-3 max-h-48 space-y-1 overflow-y-auto">
              {allSchools.map((school) => (
                <label
                  key={school.id}
                  className="flex items-center gap-2 rounded px-1 py-0.5 text-sm text-stone-700 hover:bg-stone-50"
                >
                  <input
                    type="checkbox"
              ...
              {allSchools.length === 0 && (
                <p className="text-xs text-stone-400">Loading schools...</p>
              )}
            </div>
          </section>
        ...
        <div className="space-y-6 lg:col-span-8">
          ...
          <section className="rounded-lg border border-stone-200 bg-white p-5">
            ...
            {rankedSchools.length === 0 && !loading ? (
              <div className="mt-4 rounded-md border-2 border-dashed border-stone-300 p-8 text-center text-sm text-stone-400">
                        ...
                        <div className="ml-10 mt-3 space-y-3">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Link
                              ...
                              className="rounded bg-stone-100 px-3 py-1 text-xs font-medium text-stone-700 hover:bg-stone-200"
                            >
                              View details
                            </Link>
                          </div>
          ...
          <section className="rounded-lg border border-stone-200 bg-white p-5">
            ...
            {shortlist.length === 0 ? (
              <div className="mt-4 rounded-md border-2 border-dashed border-stone-300 p-6 text-center text-sm text-stone-400">
