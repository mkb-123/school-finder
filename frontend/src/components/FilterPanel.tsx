...
export default function FilterPanel({
  ...
  const selectClasses =
    "mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm shadow-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500";
  ...
  const filterContent = (
    <div className="mt-4 space-y-5">
        ...
        <div className="flex flex-wrap gap-1.5">
          {activeLabels.map(({ key, label }) => (
            <button
              ...
              className="group inline-flex items-center gap-1 rounded-full bg-blue-50 px-2.5 py-1 text-xs font-medium text-blue-700 ring-1 ring-blue-600/10 transition-colors hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
              aria-label={`Remove filter: ${label}`}
            >
              {label}
              <X className="h-3 w-3 text-blue-400 group-hover:text-blue-600" aria-hidden="true" />
            </button>
          ))}
        </div>
      )}
      ...
      <div className="border-t border-gray-100 pt-4">
        ...
        <div className="relative mt-1">
          <input
            ...
            className="block w-full rounded-lg border border-gray-300 py-2.5 pl-3 pr-10 text-sm shadow-sm transition-colors focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
      ...
      <fieldset className="border-t border-gray-100 pt-4">
        <legend className="text-sm font-medium text-gray-700">Wraparound care</legend>
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {hasActiveFilters && (
            <button
              type="button"
              onClick={clearAll}
              className="hidden items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 lg:inline-flex"
          ...
          <button
            ...
            className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-lg text-gray-500 transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 lg:hidden"
      ...
      {!mobileOpen && activeCount > 0 && (
        <p className="mt-1 text-xs text-blue-600 lg:hidden">
      ...
      {mobileOpen && hasActiveFilters && (
        <div className="mt-2 flex lg:hidden">
          <button
            type="button"
            onClick={clearAll}
            className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
            aria-label="Clear all filters"
          >
            <RotateCcw className="h-3 w-3" aria-hidden="true" />
            Clear all filters
