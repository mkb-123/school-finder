  ...
  if (!summary || summary.total_ratings === 0) {
    return (
      <div className="flex flex-col items-center rounded-xl border border-gray-200 bg-white py-8 px-6 text-center">
        ...
        <p className="mt-3 text-sm font-medium text-gray-900">No parking ratings yet</p>
        <p className="mt-1 text-xs text-gray-500">Be the first parent to rate the school run here.</p>
      </div>
    );
  }
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2.5 text-sm">
        ...
        <span className="text-gray-400">{summary.total_ratings} rating{summary.total_ratings !== 1 ? "s" : ""}</span>
      </div>
    );
  }

  return (
    <section className="rounded-xl border border-gray-200 bg-white p-5 sm:p-6" aria-labelledby="parking-heading">
      <div className="flex items-center justify-between">
        <h3 id="parking-heading" className="text-lg font-semibold text-gray-900">
      ...
      {/* Overall score */}
      <div className="mt-4 rounded-xl bg-gray-50 border border-gray-100 p-4 sm:p-5">
          ...
          return (
            <div key={key} className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2 flex-1 justify-end">
                <div className="h-2 w-24 sm:w-32 overflow-hidden rounded-full bg-gray-200">
                  <div
